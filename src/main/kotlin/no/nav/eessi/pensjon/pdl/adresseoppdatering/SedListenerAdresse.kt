    ...
    fun consumeSedMottatt(hendelse: String, cr: ConsumerRecord<String, String>, acknowledgment: Acknowledgment) {
        MDC.putCloseable("x_request_id", UUID.randomUUID().toString()).use {
            adresseMetric.measure {
                ...
                val offsetToSkip = listOf(563319L, 563302L, 386664L, 386665L, 386666L, 437852L, 437861L, 521570L, 529077L, 530286L, 532780L, 533008L, 534633L, 534634L, 535434L, 541905L, 542460L, 542499L, 608449L, 613092L, 656516L)
